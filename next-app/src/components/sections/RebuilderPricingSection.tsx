...
const cards = [
  {
    title: "Rebuilder Clarity",
    description: "Foundational biomarkers, inflammation, nutrients, hormones, metabolic rhythm, personal health map.",
    price: "119 EUR",
    period: "6 months",
    features: [
      "Foundational biomarkers",
      "Inflammation, nutrients, hormones",
      "Metabolic rhythm",
      "Personal health map",
    ],
    ctaLabel: "Choose plan",
    ctaHref: "/checkout/rebuilder-clarity",
  },
  {
    title: "Rebuilder Stabilisation",
    description: "Everything in Clarity + 1:1 review • Monthly biomarker adjustments • Stress/sleep/cognitive optimisation • Digestive + metabolic rebuild routines.",
    price: "249 EUR",
    period: "6 months",
    features: [
      "Everything in Clarity",
      "1:1 review",
      "Monthly biomarker adjustments",
      "Stress/sleep/cognitive optimisation",
      "Digestive + metabolic rebuild routines",
    ],
  ...
  {
    title: "Rebuilder Care",
    description: "Everything in Stabilisation + Clinician-supervised recovery pathway • Medical consultations • Continuous risk monitoring • Long-term stability planning.",
    price: "499 EUR",
    period: "6 months",
    features: [
      "Everything in Stabilisation",
      "Clinician-supervised recovery pathway",
      "Medical consultations",
      "Continuous risk monitoring",
      "Long-term stability planning",
    ],
    ctaLabel: "Join waitlist",
    ctaHref: "/waitlist/rebuilder-care",
  },
];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-lg md:text-xl text-neutral-300">
            A structured path to rebuild stability, energy, and confidence.
          </p>
        </div>
