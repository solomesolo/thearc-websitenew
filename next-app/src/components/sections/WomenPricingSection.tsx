...
const cards = [
  {
    title: "Clarity Plan",
    description: "Hormone & metabolic baseline, inflammation & cardiovascular markers, personal health map, long-term risk reconstruction.",
    price: "119 EUR",
    period: "6 months",
    features: [
      "Hormone & metabolic baseline",
      "Inflammation & cardiovascular markers",
      "Personal health map",
      "Long-term risk reconstruction",
    ],
    ctaLabel: "Choose plan",
    ctaHref: "/checkout/women-clarity",
  },
  {
    title: "Stability Plan",
    description: "Everything in Clarity + 1:1 hormone health review • Monthly biomarker adjustments • Sleep & stress stabilisation • Temperature & metabolic support.",
    price: "249 EUR",
    period: "6 months",
    features: [
      "Everything in Clarity",
      "1:1 hormone health review",
      "Monthly biomarker adjustments",
      "Sleep & stress stabilisation",
      "Temperature & metabolic support",
    ],
  ...
  },
  {
    ...
    description: "Everything in Stability + Clinician-guided pathway • Medical consultations • Continuous monitoring • Longevity planning.",
    price: "499 EUR",
    period: "6 months",
    features: [
      "Everything in Stability",
      "Clinician-guided pathway",
      "Medical consultations",
      "Continuous monitoring",
      "Longevity planning",
    ],
    ctaLabel: "Join waitlist",
    ctaHref: "/waitlist/women-care",
  },
];
    ...
    <section className="relative w-full bg-black py-36 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl md:text-5xl font-semibold text-white">Health Plans (Menopause)</h2>
          <p className="text-lg md:text-xl text-neutral-300">
            Personalised menopause support grounded in biomarkers and clinical evidence.
          </p>
        </div>
