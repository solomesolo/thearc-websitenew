...
import { ScreeningPlan } from "./ScreeningPlan";
...
const sections = [
  ...
  { id: "screening", component: <ScreeningPlan /> },
  { id: "timeline", component: <SixMonthTimeline /> },
  { id: "insights", component: <KeyInsights /> },
  { id: "nextsteps", component: <NextSteps /> },
];

export function SampleBlueprintPage() {
  return (
    <main
