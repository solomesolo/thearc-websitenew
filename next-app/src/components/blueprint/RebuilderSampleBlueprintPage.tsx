...
import { RebuilderScreeningPlan } from "./RebuilderScreeningPlan";
import { RebuilderSixMonthTimeline } from "./RebuilderSixMonthTimeline";
import { RebuilderKeyInsights } from "./RebuilderKeyInsights";
import { RebuilderNextSteps } from "./RebuilderNextSteps";

const sections = [
  { id: "predisposition", component: <PredispositionMap /> },
  { id: "screening", component: <RebuilderScreeningPlan /> },
  { id: "timeline", component: <RebuilderSixMonthTimeline /> },
  { id: "insights", component: <RebuilderKeyInsights /> },
  { id: "nextsteps", component: <RebuilderNextSteps /> },
];

export function RebuilderSampleBlueprintPage() {
  return (
    <main
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 space-y-24 pb-40">
        ...
        <div className="flex flex-col gap-6 items-center justify-center pt-4">
          ...
          <Link href="/rebuilder" className="text-sm text-gray-500 hover:text-white transition">
            Back to Health Rebuilders Plans
          </Link>
        </div>
      </div>
    </main>
