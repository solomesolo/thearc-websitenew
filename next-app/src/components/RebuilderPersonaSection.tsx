      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <div className="space-y-5 text-lg text-white/70 leading-relaxed max-w-2xl mx-auto">
            <p>
              Lingering symptoms often reflect hidden biological patterns. Small biological imbalances compound over time.
            </p>
            <p>
              Without data, these remain invisible — but still affect your daily life.
            </p>
            <p className="text-white font-medium">
              The Arc helps you understand what is happening and rebuild your health with confidence.
            </p>
          </div>
        </motion.div>
      </div>
