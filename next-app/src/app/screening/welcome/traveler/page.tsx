...
export default function TravelerScreeningWelcomePage() {
  const router = useRouter();

  useEffect(() => {
    // Set persona to traveler
    setPersona('traveler');
  }, []);

  const handleStartScreening = () => {
    // Navigate to traveler-specific questionnaire
    router.push('/questionnaire/traveler');
  };
