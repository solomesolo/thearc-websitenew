...
export default function RebuilderFreeDashboardPage() {
      ...
      <main className="flex-1 min-h-screen bg-gradient-to-br from-[#0a0a0a] to-[#0f0f0f] text-white">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-slate-300/90">
            Personalized health assessment for Health Anxious Women in Menopause Rebuilders
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="flex flex-col items-center text-center relative z-10">
              ...
              <div className="mt-7 flex justify-center">
                <Link
                  href="/payment?persona=rebuilder"
                  className="
                    inline-flex
                    items-center
                    justify-center
