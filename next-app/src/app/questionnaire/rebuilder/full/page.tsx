...
function RebuilderFullQuestionnaireContent() {
  ...
  const handleSubmit = async () => {
    ...
    router.push(`/loading?persona=rebuilder&type=full`);
  };
...
export default function RebuilderFullQuestionnairePage() {
  return (
    <Suspense fallback={
      ...
      <RebuilderFullQuestionnaireContent />
    </Suspense>
  );
}
