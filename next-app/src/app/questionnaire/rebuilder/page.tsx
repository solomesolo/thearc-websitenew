...
export default function RebuilderQuestionnairePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      localStorage.setItem("questionnairePersona", "rebuilder");
      ...
      if (isLoggedIn) {
        ...
        router.push("/loading?persona=rebuilder");
      } else {
        // User not logged in, redirect to signup with persona info
        router.push("/signup?persona=rebuilder&redirect=/loading");
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] to-[#0f0f0f] text-white py-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400">Health Anxious Women in Menopause Rebuilders</p>
        </motion.div>
