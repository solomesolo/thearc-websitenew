        ...
        <div className="relative max-w-[1320px] mx-auto px-6 lg:px-10 pt-32 md:pt-40 pb-28 min-h-[90vh] flex items-end justify-end">
          <div className="max-w-[650px] space-y-8 ml-auto mr-0 md:mr-8 lg:mr-16 mb-16 md:mb-24 lg:mb-32">
            ...
            >
              ...
              <Link
                href="/waitlist/self-experimentation"
                className="inline-flex items-center justify-center gap-2 rounded-full px-8 py-3 text-sm font-semibold bg-transparent border border-white/20 text-white/80 hover:bg-white/5 hover:border-white/30 hover:text-white transition-all"
              >
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <div className="mt-12 md:mt-14 grid gap-10 md:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)] items-start">
            ...
            <div className="flex md:justify-end">
              <div className="relative w-full max-w-xs md:max-w-sm aspect-[3/4] rounded-3xl overflow-hidden border border-white/10 bg-white/5 bg-gradient-to-b from-white/10 via-white/3 to-transparent shadow-[0_30px_80px_rgba(0,0,0,0.75)] backdrop-blur-xl">
                <img
                  src="/why it works_about the arc.png"
